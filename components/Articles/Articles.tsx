                    ...
                    <ul className={css.articlesGroup}>
                        <li>
                            <article className={`${css.articleCard} ${css.PS5_1}`}>
                                ...
                                <Link href="/interesting-articles/economical-and-convenient">
                                    <button type="button" className={css.articleButton}>Читати більше</button></Link>
                            </article>
                        </li>
                        <li>
                    ...
                    <ul className={css.articlesGroup}>
                        <li>
                            <article className={`${css.articleCard} ${css.PS5_3}`}>
                                ...
                                <Link href="/interesting-articles/top">
                                    <button type="button" className={css.articleButton}>Читати більше</button></Link>
                            </article>
                        </li>
                        <li>
                            <article className={`${css.articleCard} ${css.PS5_4}`}>
                                ...
                                <Link href="/interesting-articles/choice">
                                    <button type="button" className={css.articleButton}>Читати більше</button></Link>
                            </article>
                        </li >
                        <li>
                            <article className={`${css.articleCard} ${css.PS5_5}`}>
                                ...
                                <Link href="/interesting-articles/playstation-on-holiday">
                                    <button type="button" className={css.articleButton}>Читати більше</button></Link>
                            </article>
                        </li >
                    </ul >
                    ...
                    <ul className={css.articlesGroup}>
                        <li>
                            <article className={`${css.articleCard} ${css.PS5_6}`}>
                                ...
                                <Link href="/interesting-articles/hot-hits">
                                    <button type="button" className={css.articleButton}>Читати більше</button></Link>
                            </article>
                        </li>
                        <li>
                            <article className={`${css.articleCard} ${css.PS5_7}`}>
                                ...
                                <Link href="/interesting-articles/rent-vs-buy">
                                    <button type="button" className={css.articleButton}>Читати більше</button></Link>
                            </article>
                        </li >
                        <li>
                            <article className={`${css.articleCard} ${css.PS5_8}`}>
                                ...
                                <Link href="/interesting-articles/convenient-rental">
                                    <button type="button" className={css.articleButton}>Читати більше</button></Link>
                            </article>
                        </li >
                    </ul >
